...
# SMALL FIXES
# ---------------------------------------------------------------------------
# Homepage wallpaper fix
vals = {'datas': source.env['ir.attachment'].browse(209).datas}
get_target_record_from_id('ir.attachment', 209).write(vals)
# Company small logo fix
target.env['website'].browse(1).logo = source.env['res.company'].browse(1).logo
